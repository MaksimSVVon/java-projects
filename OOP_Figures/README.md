...
### Description
Please, make [`Triangle`](src/main/java/corejava/tasks/figures/Triangle.java),
[`Quadrilateral`](src/main/java/corejava/tasks/figures/Quadrilateral.java),
[`Circle`](src/main/java/corejava/tasks/figures/Circle.java) classes
extend [`Figure`](src/main/java/corejava/tasks/figures/Figure.java) abstract class.
...
1. `public String pointsToString()`\
    ...
    *Note:*: you may benefit from implementing toString() in the [`Point`](src/main/java/corejava/tasks/figures/Point.java) class
...
[`Point`](src/main/java/corejava/tasks/figures/Point.java) class is already there.
