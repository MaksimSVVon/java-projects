...
### Описание
Нужно сделать так, чтобы классы  [`Triangle`](src/main/java/corejava/tasks/figures/Triangle.java),
[`Quadrilateral`](src/main/java/corejava/tasks/figures/Quadrilateral.java),
[`Circle`](src/main/java/corejava/tasks/figures/Circle.java) расширяли абстрактный класс [`Figure`](src/main/java/corejava/tasks/figures/Figure.java).
...
3. `public String pointsToString()`\
    ...
    *Примечание:* можно реализовать toString () в классе [`Point`](src/main/java/corejava/tasks/figures/Point.java).
...
Класс [`Point`](src/main/java/corejava/tasks/figures/Point.java) уже реализован.
