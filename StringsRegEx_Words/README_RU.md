...
Реализуйте методы класса [`StringUtil`](src/main/java/corejava/tasks/words/StringUtil.java):
...
### Примеры 
Вы можете использовать метод `main` класса [`StringUtil`](src/main/java/corejava/tasks/words/StringUtil.java)
